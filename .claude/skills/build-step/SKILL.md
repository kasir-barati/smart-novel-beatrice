---
name: build-step
description: Implement, test, and commit exactly one step of the feature from REQUIREMENTS.md, following docs/process/PROCESS.md and docs/process/SELF_IMPROVE.md. Use when the user asks to build/continue/resume the next step, or names a step number.
---
